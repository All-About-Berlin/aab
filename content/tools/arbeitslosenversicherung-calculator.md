...
If you earn more than (the *[[Beitragsbemessungsgrenze]]*), you pay the maximum amount: {{ARBEITSLOSENVERSICHERUNG_EMPLOYEE_RATE}}% of {{BEITRAGSBEMESSUNGSGRENZE_EAST|cur}}€. You will not pay more than that, even if your income goes up.[^1]

### In West Germany

If you earn more than (the *[[Beitragsbemessungsgrenze]]*), you pay the maximum amount: {{ARBEITSLOSENVERSICHERUNG_EMPLOYEE_RATE}}% of {{BEITRAGSBEMESSUNGSGRENZE_WEST|cur}}€. You will not pay more than that, even if your income goes up.[^1]
