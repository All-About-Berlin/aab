...
1.5% tax on sale of company to your holding.
...
But you can keep the money in the holding, and reinvest it in ETFs. You're investing ~70% of your total profit, instead of whatever your personal post-tax income would be.

Good explanation here: https://eidel.io/posts/how-to-found-a-company-in-germany-14-easy-steps-and-lots-of-pain#:~:text=Scenario%202%3A-,holding,-Magic%20Software%20GmbH

Expanded here: https://eidel.io/posts/holding-gmbh-vs-normal-gmbh-in-germany-worth-the-hassle
...
UG is cheaper to start, but can be [a bad idea later](https://eidel.io/posts/all-my-hacks-for-founding-a-company-in-germany-and-running-it#:~:text=don't%20found%20a%20ug.%20found%20a%20gmbh%20instead.). Why?[^4]

25k capital still required, just paid in instalments out of your profit, instead of in a lump sump.[^39]
...
Vorratsgesellschaft? Repurposed companies, readymade companies.[^36] HN user recommended [Foris](https://www.foris.com/en/shelf-companies/).[^16] More expensive than starting your own GmbH, but faster, might come with bank account.

Some are "virgin" and have no history. Others already have a history, and that can be risky.[^56]
...
Do it before 31 August to apply the status retroactively for the current year. This allows tax savings to apply for the current year.[^34]

Yearly time for paperwork?
...
- Tax advisor fees, €1k or more per year, mostly for Jahresabschluss[^21]
- [[IHK]] fee
...
- What happens when founders have disagreement (Abfindungsklausel)[^3]
...
The validation process is completely random.[^38]
...
You must have a notary. They will register the company for you. There is no other option. The notary is not a consultant. They will not explain how the process works.[^53]
...
Gewinnermittlung becomes opening balance sheet of company.

Can be retroactively applied, up to August 31. Cannot be done super quickly because notaries have limited availability.

Einzelunternehmer -> e.K. -> GmbH

Bring passport or *[[Personalausweis]]* to appointment[^5]

If you're abroad, https://online.notar.de/ can be useful. Otherwise it's the same as an in-person appointment. It only saves you the trip, and you pay extra for that.
...
Move the initial capital from your personal bank account to your corporation's bank account.[^58]
...
Especially slow in Berlin.[^35]

Notary completes the incorporation, adds you to Handelsregister, sends you confirmation document. The Handelsregister entry is mandatory for a GmbH.[^40]
...
### 12. Transparenzregister

Done online. Tax advisor can do it for you?[^43]

Required for all UGs and GmbHs.[^41]

Required for all partners with over 25% ownership.

Do it within 2 weeks of Handelsregister entry.[^42]

https://www.transparenzregister.de/

€{{TRANSPARENZREGISTER_FEE|cur}} per year fee, comes from Bundesanzeiger Verlag[^33]

### 13. Get a tax ID and VAT ID

If you were already an Einzelunternehmer, do you need a new tax ID?

- request a EU VAT ID
- estimated profit €0 (to avoid tax prepayments)
- Bargründung?

Get both a bit later, as described in Fragebogen guide.

- [ ] Update fragebogen guide
- [ ] Update tax ID guide
...
Register with the Gewerbeamt. Required for all GmbHs.[^54]
...
Gesamtrechtsnachfolge: Any contracts already signed as freelancer goes to company.

### Social contributions

From social security perspective, no need to contribute.

Health insurance contributions made privately, not through company.

Why does the TK API ask if you're a Geschäftführer?

AltGesellschafterhaftung: Any contracts already signed as freelancer are not covered by limited liability.

### IHK membership

All companies must be part of the [[IHK]] and pay the membership fee.

How much is it? When is it paid?

### Selling company

Cannot sell shares of AAB for 7 years. If leaving within 7 years, might trigger a full taxation of sale AAB. Schädliches Ereignis innerhalb der Sperrfrist von 7 Jahren.

At liquidation, paid at 60% of usual tax rate. For example 60% of 45%.

If leaving Germany, it's taxed at 60% of 45%.

### Business expenses

Don't buy private things with company account. The company owns it, and it's taxed as income on sale. Especially applies to real estate.

### Personal finances

If trying to get a loan, most banks consider this change as if becoming a freelancer from scratch. Need to rebuild trust to get credit.
...
B1 German recommended.[^55] There is a surcharge for English-speaking notaries, document translations.
...
[^4]: [Oliver Eidel](https://eidel.io/posts/how-to-found-a-company-in-germany-14-easy-steps-and-lots-of-pain#:~:text=or%2C%20you%20could%20not%20found%20a%20gmbh%20but%20a%20ug) (2024), [Alexander von Engelhardt](https://www.vonengelhardt.com/en/miscellanious#:~:text=towards%20the%20end%20of%20the%20year%20being%20a%20bad%20idea.%20why%20is%20that%20a%20bad%20idea%3F)
[^5]: [Oliver Eidel](https://eidel.io/posts/how-to-found-a-company-in-germany-14-easy-steps-and-lots-of-pain#:~:text=don%E2%80%99t%20forget%20your%20id%20or%20passport) (2024)
[^6]: [Oliver Eidel](https://eidel.io/posts/how-to-found-a-company-in-germany-14-easy-steps-and-lots-of-pain#:~:text=don%E2%80%99t%20forget%20your%20id%20or%20passport) (2024)
[^7]: [Oliver Eidel](https://eidel.io/posts/how-to-found-a-company-in-germany-14-easy-steps-and-lots-of-pain#:~:text=costs%20of%20approximately%201k%E2%82%AC) (2024), [Hacker News](https://news.ycombinator.com/item?id=39969456) (2024), [on-promise.cloud](https://www.on-promise.cloud/en/compendium/01-how-much-does-a-gmbh-cost.html#overview-for-the-first-business-year), [Carmine Paolino](https://paolino.me/founding-a-company-in-germany/) (2026)
...
[^36]: [Hacker News](https://news.ycombinator.com/item?id=31621254) (2022), [Alexander von Engelhardt](https://www.vonengelhardt.com/en/shelf-company-or-scratch-founding#gsc.tab=0)
...
[^50]: [Alexander von Engelhardt](https://www.vonengelhardt.com/en/money-company) (2026)
[^51]: Citation needed
