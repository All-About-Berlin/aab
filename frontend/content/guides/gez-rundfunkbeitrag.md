...
**[Payment information](https://www.rundfunkbeitrag.de/zahlung/index_ger.html)** (in German) - rundfunkbeitrag.de
...
5. Enter your bank information (your [[IBAN]] and account name), and save the form.

![GEZ SEPA payment method](/images/gez-sepa-payment-method.png)

### Pay by bank transfer

Every 3 months, you will get a [letter from the *Beitragsservice*](/images/gez-rundfunkbeitrag-payment.jpg). The letter has the correct payment details. It also has a QR code that you can scan with your banking app.

How to pay by bank transfer:

1. Find your account number (*Beitragsnummer*). It's on the letters the *Beitragsservice* sends you. It has 9 digits. You can also use the last 9 digits of the payment reference number (RF30X<u>000000000</u>).
...
> **Recipient:** Rundfunk ARD, ZDF, DRadio  
...
[^9]: [rundfunkbeitrag.de](https://www.rundfunkbeitrag.de/buergerinnen_und_buerger/informationen/menschen_mit_behinderung/index_ger.html), [§ 5 Abs. 3 RBStV](https://bravors.brandenburg.de/vertraege/rbstv)
...
[^11]: [§ 3 Abs. 2 RBStV](https://bravors.brandenburg.de/vertraege/rbstv)
[^12]: [§ 3 Abs. 1 RBStV](https://bravors.brandenburg.de/vertraege/rbstv)