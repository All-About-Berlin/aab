...
- It's harder to make friends and join communities. You live in the [expat bubble](https://www.internations.org/guide/global/living-in-another-country-blending-in-15286/the-expat-bubble-2).
- It's harder to [find an apartment](/guides/find-a-flat-in-berlin).
- It's harder to [find a job](/guides/find-a-job-in-berlin). Many jobs require German. There are fewer jobs in your language.
...
If you just [moved to Germany](/guides/moving-to-berlin), German classes can help you [make friends](/guides/making-friends) and learn about German culture.

### To study in Berlin

Some German universities have programmes in English, but most are only in German. If you want to study in German, you must speak German at a B1 to C1 level. You might need an official language certificate[^0] to enrol in university.

**Useful link:** [Search for university programmes in English](https://www2.daad.de/deutschland/studienangebote/international-programmes/en/) - DAAD
...
- **[Volkshochschule (VHS)](https://www.berlin.de/vhs/service/vhs-in-english/learning-german/learning-german/learning-german-761377.en.php)**  
    The community colleges (*[[Volkshochschule]]*) have German classes. They are very affordable. They also have online classes. To join a class, you must take a placement test. I tried to take classes at the VHS, but found it too difficult to sign up for classes.
...
- **[sprachenatelier](https://www.sprachenatelier-berlin.de/en/)**  
...
- [Language Tandem Berlin](https://www.facebook.com/groups/LaTaBe/) - Facebook, over 35,000 members
...
[Speakeasy](https://www.speakeasysprachzeug.de/en/events) and [Sprachsalon Berlin](https://www.sprachsalon-berlin.de/en/about-us/) sometimes organise workshops and events. It's a good way to learn the language and make new friends. There are more language learning events on [Meetup.com](https://www.meetup.com/).
...
- [German courses with scholarships](https://www2.daad.de/deutschland/studienangebote/sommerkurse/en/result/?q=&lang%5B%5D=1&fos=&scholarshipLC=true&langExamLC=&scholarshipSC=&langExamSC=°ree%5B%5D=5&lvlDe%5B%5D=&dat%5B%5D=&cit%5B%5D=&tyi%5B%5D=&ins%5B%5D=&sort=4&dur=&subjects%5B%5D=&limit=10&offset=&display=list) - DAAD
- [Scholarship database](https://www2.daad.de/deutschland/stipendium/datenbank/en/21148-scholarship-database/) - DAAD
...
I use [dict.cc](https://www.dict.cc/) to translate words. It's the best German dictionary I know. They also have an app.

I use [Linguee](https://www.linguee.com/) to find examples. It shows you how words are used in a sentence, next to their translation.

I use [DeepL](https://www.deepl.com/en/translator) to translate longer texts. It's much better than Google Translate.
...
[^4]: [Quora](https://www.quora.com/Do-all-native-speakers-speak-their-native-languages-at-C2-level)
