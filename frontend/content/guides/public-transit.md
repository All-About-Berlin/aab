...
You can rent electric scooters (🛴) from [Bolt](https://bolt.eu/en-de/scooters/), [Dott](https://ridedott.com/), [Lime](https://www.li.me/en-de/) or [Voi](https://www.voi.com/city/berlin).{{ fail_on('2027-03-31') }} You do not need a driving licence. You can book them in the [Jelbi](https://www.jelbi.de/en/home/) app.

### Rent a moped

You can rent motor scooters (🛵) from [Emmy](https://emmy-sharing.de/en/) or [Dance](https://dance.co/mobility/mopeds/berlin).{{ fail_on('2027-03-31') }} You can book Emmy scooters in the [Jelbi](https://www.jelbi.de/en/home/) app too. Create an account in advance, because their verification process is unreliable.
...
Rent a car for a few days with [Miles](https://miles-mobility.com/en-de/car-sharing/berlin), [Sixt](/out/sixt), [Avis](https://www.avis.de/), [Budget](https://www.budget.de/) or [Europcar](https://www.europcar.de/de-de).{{ fail_on('2027-12-31') }} [RentalCars.com](https://www.rentalcars.com/en/) can help you find a rental car.
