...
- **The country code** (*Ländervorwahl*)  
    Germany's country code is **+49** or **0049**.
- **The area code** (*Vorwahl*)  
    Berlin's area code is **30**. Mobile phone numbers have a different area code, like **1522**. See the [list of area codes](https://en.wikipedia.org/wiki/List_of_dialling_codes_in_Germany). If there is no country code, put a 0 before the area code. For example, 030 or 01522.
- **The local number** (*Rufnummer*)  
...
If a number starts with **0900** or **0137**, it's a premium number.[^4] When you call premium numbers, you pay a fee. For example, **[09008 529 366 11](tel:0900852936611)** is a legal hotline that costs €{{LEGAL_HOTLINE_COST_PER_MINUTE|cur}} per minute. The cost is charged on your phone bill.

[^1]: [placetel.de](https://www.placetel.de/blog/telefonnummer-schreibweise-richtig-schreiben)
...
[^5]: [Wikipedia](https://en.wikipedia.org/wiki/E.123)