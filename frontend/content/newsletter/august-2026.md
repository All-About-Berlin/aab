...
If you go on sick leave for more than 3 days, you need a [sick note](/glossary/Krankschreibung) from the doctor. Employers can ask for a sick note on the first day, but that rarely happens.

The government wants to require a sick note on the first day.[^6] Merz thinks that Germans take too many sick days, and wants to fix that. He also wants to abolish getting a sick note by phone.

We don't know when this will take effect.

**[How sick leave works ➞](/guides/sick-leave)**

### All-day care in elementary school

Children go to *[[Kita]]* until they start [elementary school](/glossary/Grundschule). Some elementary schools only have lessons in the morning. Parents must care for their children in the afternoon. This is changing.

First-graders can now get 8 hours of care per day, 5 days per week. For example, a child can spend 4 hours in school, then 4 hours in after-school care. This will extend to second-graders next year, then third-graders the year after, and finally to fourth-graders.[^3]

This change does not affect Berliners, as this is how things already work in Berlin elementary schools.[^2]

**[How the Kitagutschein works ➞](/guides/kitagutschein)**
...
If a human has reviewed the content and is responsible for its accuracy, no disclosure is needed. In other words, this new law mostly applies to fully automated AI-generated content.

Businesses must also inform users when they interact with AI. This applies for example to AI chatbots.[^1]
...
In July, I was interviewed by Adrian Ma for the NPR Planet Money podcast. The episode is a succinct explanation of how Google's AI summaries are destroying the web.
