...
Clocks *fall* an hour behind on the last Sunday of October, then *spring* an hour forward on the last Sunday of March.[^3]

At 3:00 on the night of October 24 to 25, you must set your clocks back one hour. You will get an extra hour of sleep, but the sun will set at 17:00. Ouch.

### Cyberattacks and data breach

Last August, a group of hackers stole 5.8 terabytes of data from Berlin's city government. When Berlin refused to pay a 2 million euro ransom, the hackers leaked the data on the dark web. The government is still figuring out what data was leaked.
...
Starting October 15, alcohol will be banned in all Deutsche Bahn stations.[^4] The ban has started earlier at Zoo, Ostbahnhof, Hauptbahnhof and Gesundbrunnen, although alcohol is still sold there. Alcohol is still permitted in BVG stations.[^5]

Is this the end of the *[Faustmolle](https://de.wiktionary.org/wiki/Faustmolle)*? Probably not. Eating and drinking on the U-Bahn is not allowed, and neither is smoking on train platforms, but that has not stopped anyone.[^6]
...
There was some controversy over the exclusion of "Mehrzweckeier". The term is a play on "Merz leck Eier" (Merz lick balls). It comes from a protest sign against Friedrich Merz that went viral and got turned into a [song](https://www.youtube.com/watch?v=jcB4zu4KX10).[^10]
...
A good forum requires a good search function. I have implemented a snappy, effective full-site search. It returns results from the content and the forum. It will go live along with the forum.

### Guide updates

I have rewritten my ["Steuerberater vs Buchhalter" guide](/guides/steuerberater-vs-buchhalter) based on feedback from [Johann Degraf](https://numpro.de/). The new version is clearer and gives better advice.

I am still working on my incorporation guide. The many founders I have spoken with seem traumatized by their experience. Founding a GmbH is a showcase of everything wrong with German bureaucracy: it's slow, it's paper-based, and it requires hiring expensive and hard-to-find experts. The reward is paying half a dozen new taxes and fees just for existing, and an extra serving of paperwork.

I can't prevent that, but I can prepare you for it.
...
If you know something about this document, [email me](/contact).
...
- **You need your landlord's permission**  
    Failing to do that can get you kicked out.[^2] If you sublet the whole apartment, the landlord can refuse, and there is nothing you can do about it.[^1] You don't need permission to sublet to your spouse, parents or children.
