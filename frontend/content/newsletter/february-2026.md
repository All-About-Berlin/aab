...
[A third of immigrants are thinking of leaving](https://www.dezim-institut.de/publikationen/auswanderung-im-fokus-wer-bleibt-wer-will-gehen/). Half of them seek to improve their standard of living. I have just released a guide for leaving Germany.
...
The exit tax is why this guide took four weeks to write. I have read about it for days, then validated my understanding with [my delightfully plain-spoken tax advisor](https://stb-goeydeniz.de/).
...
Oliver Eidel also created [an entire website about the exit tax](https://wegzugsteuer.info/). It's based on his own chats with tax advisors, and it's refreshingly straightforward.
...
- [Apartment affordability calculator](https://www.berlinrelo.de/#calculator) - It tells you what kind of rent you can afford, and how long your flat search might take.
