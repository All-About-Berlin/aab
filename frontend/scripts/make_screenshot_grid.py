...
PAGES = [
    ...
    ("Forum new thread", f"{MAIN}/forum/new"),
    ("Forum rules", f"{MAIN}/forum/rules"),
    ("Forum login", f"{MAIN}/forum/login"),
    ("Forum signup", f"{MAIN}/forum/signup"),
    ("Forum signup welcome", f"{MAIN}/forum/signup/welcome"),
    ("Forum email verification sent", f"{MAIN}/forum/confirm-email"),
    ("Forum password reset", f"{MAIN}/forum/password/reset"),
    ("Forum password reset done", f"{MAIN}/forum/password/reset/done"),
    ("Forum password reset from key done", f"{MAIN}/forum/password/reset/key/done"),
