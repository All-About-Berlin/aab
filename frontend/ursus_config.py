...
ctx["PENSION_CONTRACTING_COUNTRIES"] = or_list(ctx["PENSION_CONTRACTING_COUNTRIES"])
ctx["PENSION_BALKAN_BLOCK_COUNTRIES"] = or_list(ctx["PENSION_BALKAN_BLOCK_COUNTRIES"])
ctx["PENSION_DISQUALIFYING_COUNTRIES"] = or_list(ctx["PENSION_DISQUALIFYING_COUNTRIES"])
ctx["WORKING_HOLIDAY_VISA_COUNTRIES"] = or_list(ctx["WORKING_HOLIDAY_VISA_COUNTRIES"])
