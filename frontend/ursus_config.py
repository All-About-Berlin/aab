...
_v = _load_constants(Path(__file__).parent / "constants.json")
...
ctx["MINIMUM_WAGE"] = _v["MINIMUM_WAGE"]

ctx["MEDIAN_INCOME_BERLIN"] = _v["MEDIAN_INCOME_BERLIN"]
ctx["MEDIAN_INCOME_GERMANY"] = _v["MEDIAN_INCOME_GERMANY"]

ctx["AU_PAIR_MIN_ALLOWANCE"] = _v["AU_PAIR_MIN_ALLOWANCE"]

# Maximum income used to calculate pension contributions (€/y)
ctx["BEITRAGSBEMESSUNGSGRENZE"] = _v["BEITRAGSBEMESSUNGSGRENZE_MONTHLY"] * 12  # § SGB 6 Anlage 2 [BBGRV]

ctx["GRUNDFREIBETRAG"] = _v["GRUNDFREIBETRAG"]  # § 32a EstG [GFB]
ctx["INCOME_TAX_BRACKET_2_MAX_INCOME"] = _v["INCOME_TAX_BRACKET_2_MAX_INCOME"]  # § 32a EstG [UPTAB26 - 1]
ctx["INCOME_TAX_BRACKET_3_MAX_INCOME"] = _v["INCOME_TAX_BRACKET_3_MAX_INCOME"]  # § 32a EstG [UPTAB26 - 1]
ctx["INCOME_TAX_BRACKET_4_MAX_INCOME"] = _v["INCOME_TAX_BRACKET_4_MAX_INCOME"]  # § 32a EstG [UPTAB26 - 1]

# Upper bound (€/y) of income tax tariff zones for tax classes 5 and 6
ctx["INCOME_TAX_CLASS_56_LIMIT_1"] = _v["INCOME_TAX_CLASS_56_LIMIT_1"]  # § 39b Abs. 2 Satz 7 EstG [W1STKL5]
ctx["INCOME_TAX_CLASS_56_LIMIT_2"] = _v["INCOME_TAX_CLASS_56_LIMIT_2"]  # § 39b Abs. 2 Satz 7 EstG [W2STKL5]
ctx["INCOME_TAX_CLASS_56_LIMIT_3"] = _v["INCOME_TAX_CLASS_56_LIMIT_3"]  # § 39b Abs. 2 Satz 7 EstG [W3STKL5]

ctx["INCOME_TAX_MAX_RATE"] = _v["INCOME_TAX_MAX_RATE"]  # (%) - § 32b EstG

ctx["CHURCH_TAX_RATE"] = _v["CHURCH_TAX_RATE"]  # (%)
ctx["CHURCH_TAX_RATE_BW_BY"] = _v["CHURCH_TAX_RATE_BW_BY"]  # (%)

ctx["SOLIDARITY_TAX_MILDERUNGSZONE_MIN_INCOME_TAX"] = _v[
    "SOLIDARITY_TAX_MILDERUNGSZONE_MIN_INCOME_TAX"
]  # § 3 SolzG [SOLZFREI]
ctx["SOLIDARITY_TAX_MILDERUNGSZONE_RATE"] = _v["SOLIDARITY_TAX_MILDERUNGSZONE_RATE"]  # § 4 SolzG
ctx["SOLIDARITY_TAX_MAX_RATE"] = _v["SOLIDARITY_TAX_MAX_RATE"]  # § 4 SolzG

ctx["WERBUNGSKOSTEN_PAUSCHALE"] = _v["WERBUNGSKOSTEN_PAUSCHALE"]
ctx["VORSORGEPAUSCHAL_MIN"] = _v["VORSORGEPAUSCHAL_MIN"]  # § 39b Abs. 2.3.e EStG
ctx["VORSORGEPAUSCHAL_MIN_TAX_CLASS_3"] = _v["VORSORGEPAUSCHAL_MIN_TAX_CLASS_3"]
ctx["ARBEITNEHMERPAUSCHALE"] = _v["ARBEITNEHMERPAUSCHALE"]  # (€/y) - § 9a EStG
ctx["SONDERAUSGABEN_PAUSCHBETRAG"] = _v["SONDERAUSGABEN_PAUSCHBETRAG"]  # (€/y) § 10c EStG [SAP]

ctx["ARBEITSLOSENVERSICHERUNG_EMPLOYEE_RATE"] = _v["ARBEITSLOSENVERSICHERUNG_RATE"] / 2  # § 341 SGB 3, BeiSaV 2019

# Kindergeld amount per child (€/m) - § 6 Abs. 1 BKGG, § 66 EStG
ctx["KINDERGELD"] = _v["KINDERGELD"]

# Tax break for parents (€/y) - § 32 Abs. 6 EStG [KFB] - monitored
ctx["KINDERFREIBETRAG"] = _v["KINDERFREIBETRAG"]

# Tax break for single parents (€/y) - § 24b EStG [EFA]
ctx["ENTLASTUNGSBETRAG_ALLEINERZIEHENDE"] = _v["ENTLASTUNGSBETRAG_ALLEINERZIEHENDE"]
ctx["ENTLASTUNGSBETRAG_ALLEINERZIEHENDE_EXTRA_CHILD"] = _v["ENTLASTUNGSBETRAG_ALLEINERZIEHENDE_EXTRA_CHILD"]

ctx["CAPITAL_GAINS_TAX_RATE"] = _v["CAPITAL_GAINS_TAX_RATE"]  # (%) - § 32d EStG
...
ctx["GEWERBESTEUER_RATE"] = _v["GEWERBESTEUER_RATE"]

# The part of the Gewerbesteuer that is credited from your income tax (%)
ctx["GEWERBESTEUER_TAX_CREDIT"] = _v["GEWERBESTEUER_TAX_CREDIT"]  # (%) - TODO: Not watched, no source

ctx["GEWERBESTEUER_HEBESATZ_BERLIN"] = _v["GEWERBESTEUER_HEBESATZ_BERLIN"]  # (%) - TODO: Not watched
...
ctx["VAT_RATE"] = _v["VAT_RATE"]
ctx["VAT_RATE_REDUCED"] = _v["VAT_RATE_REDUCED"]
...
ctx["MIDIJOB_MAX_INCOME"] = _v["MIDIJOB_MAX_INCOME"]

# Used to calculate health insurance for a midijob
ctx["GKV_FACTOR_F"] = _v["GKV_FACTOR_F"]  # § 20 SGB IV - TODO: Can be calculated from other vals

# Median income (€/m) of all people who pay social contribs
ctx["BEZUGSGROESSE"] = _v["BEZUGSGROESSE"]  # SGB VI Anlage 1

# Base contribution (%), including Krankengeld
ctx["GKV_BASE_RATE_EMPLOYEE"] = _v["GKV_BASE_RATE_EMPLOYEE"]  # § 241 SGB V
...
ctx["GKV_BASE_RATE_SELF_PAY"] = _v["GKV_BASE_RATE_SELF_PAY"]  # § 243 SGB V
...
ctx["GKV_MAX_INCOME"] = _v["GKV_MAX_INCOME_MONTHLY"] * 12  # SVBezGrV 2021 [BBGKVPV]

# Above this income (€/mth), your employer pays for health insurance
ctx["GKV_AZUBI_FREIBETRAG"] = _v["GKV_AZUBI_FREIBETRAG"]  # § 20 Abs. 3 SGB IV
...
ctx["GKV_FREIWILLIG_VERSICHERT_MIN_INCOME"] = _v["GKV_FREIWILLIG_VERSICHERT_MIN_INCOME_MONTHLY"] * 12

# If you earn less than that (€/y), private health insurers usually reject you
ctx["PKV_MIN_INCOME"] = _v["PKV_MIN_INCOME"]
...
ctx["GKV_MIN_ZUSATZBEITRAG"] = _v["GKV_MIN_ZUSATZBEITRAG"]  # HKK
ctx["GKV_MAX_ZUSATZBEITRAG"] = _v["GKV_MAX_ZUSATZBEITRAG"]  # AOK Nordost
ctx["GKV_AVG_ZUSATZBEITRAG"] = _v["GKV_AVG_ZUSATZBEITRAG"]

ctx["GKV_ZUSATZBEITRAG_AVERAGE"] = ctx["GKV_AVG_ZUSATZBEITRAG"]
ctx["GKV_ZUSATZBEITRAG_AOK"] = _v["GKV_ZUSATZBEITRAG_AOK"]
ctx["GKV_ZUSATZBEITRAG_BARMER"] = _v["GKV_ZUSATZBEITRAG_BARMER"]
ctx["GKV_ZUSATZBEITRAG_DAK"] = _v["GKV_ZUSATZBEITRAG_DAK"]
ctx["GKV_ZUSATZBEITRAG_HKK"] = _v["GKV_ZUSATZBEITRAG_HKK"]
ctx["GKV_ZUSATZBEITRAG_TK"] = _v["GKV_ZUSATZBEITRAG_TK"]

ctx["TRAVEL_INSURANCE_COST"] = _v["TRAVEL_INSURANCE_COST"]
ctx["EXPAT_INSURANCE_COST"] = {
    "feather-basic": _v["EXPAT_INSURANCE_COST_FEATHER_BASIC"],
    "feather-premium": _v["EXPAT_INSURANCE_COST_FEATHER_PREMIUM"],
    "ottonova-expat": _v["EXPAT_INSURANCE_COST_OTTONOVA_EXPAT"],
    "hansemerkur-basic": _v["EXPAT_INSURANCE_COST_HANSEMERKUR_BASIC"],
    "hansemerkur-profi": _v["EXPAT_INSURANCE_COST_HANSEMERKUR_PROFI"],
}

ctx["EXPAT_STUDENT_COST"] = _v["EXPAT_STUDENT_COST"]  # /out/feather-expats

# Maximum daily Krankengeld
ctx["GKV_KRANKENGELD_DAILY_LIMIT"] = (ctx["GKV_MAX_INCOME"] * Decimal("0.7") / 360).normalize()  # § 47 SGB V

# BAFöG Bedarfssatz (€/y)
ctx["BAFOG_BEDARFSSATZ"] = _v["BAFOG_BEDARFSSATZ"]  # § 13 BAföG Abs 1.2 + 2.2
ctx["SPERRKONTO_AMOUNT"] = (
    ctx["BAFOG_BEDARFSSATZ"] + _v["SPERRKONTO_SURCHARGE_INSURANCE"] + _v["SPERRKONTO_SURCHARGE_OTHER"]
...
ctx["PFLEGEVERSICHERUNG_BASE_RATE"] = _v["PFLEGEVERSICHERUNG_BASE_RATE"]
...
ctx["PFLEGEVERSICHERUNGS_SURCHARGE"] = _v["PFLEGEVERSICHERUNGS_SURCHARGE"]  # § 55 Abs. 3 SGB XI
ctx["PFLEGEVERSICHERUNG_DISCOUNT_PER_CHILD"] = _v["PFLEGEVERSICHERUNG_DISCOUNT_PER_CHILD"]  # § 55 Abs. 3 SGB XI
...
ctx["RV_BASE_RATE"] = _v["RV_BASE_RATE"]  # RVBeitrSBek 202X
ctx["RV_EMPLOYEE_CONTRIBUTION"] = _v["RV_EMPLOYEE_CONTRIBUTION"]
ctx["RV_MIN_CONTRIBUTION"] = (ctx["RV_BASE_RATE"] * ctx["MINIJOB_MAX_INCOME"] / 100).normalize()

ctx["FUNDSBACK_FEE"] = _v["FUNDSBACK_FEE"]  # %
ctx["FUNDSBACK_MIN_FEE"] = _v["FUNDSBACK_MIN_FEE"]  # €
ctx["FUNDSBACK_MAX_FEE"] = _v["FUNDSBACK_MAX_FEE"]  # €
ctx["GERMANYPENSIONREFUND_FEE"] = _v["GERMANYPENSIONREFUND_FEE"]  # %
ctx["PENSIONREFUNDGERMANY_FEE"] = _v["PENSIONREFUNDGERMANY_FEE"]  # %
...
ctx["BVG_AB_TICKET"] = _v["BVG_AB_TICKET"]
ctx["BVG_ABC_TICKET"] = _v["BVG_ABC_TICKET"]
ctx["BVG_FINE"] = _v["BVG_FINE"]
ctx["BVG_REDUCED_FINE"] = _v["BVG_REDUCED_FINE"]
ctx["DEUTSCHLAND_TICKET_PRICE"] = _v["DEUTSCHLAND_TICKET_PRICE"]
...
ctx["RESIDENCE_PERMIT_REPLACEMENT_FEE"] = _v["RESIDENCE_PERMIT_REPLACEMENT_FEE"]  # § 45c AufenthG
...
ctx["FREELANCE_VISA_MIN_MONTHLY_PENSION"] = _v["FREELANCE_VISA_MIN_MONTHLY_PENSION"]
...
ctx["FREELANCE_VISA_MIN_INCOME"] = _v["FREELANCE_VISA_MIN_INCOME"]
...
ctx["CITIZENSHIP_TEST_FEE"] = _v["CITIZENSHIP_TEST_FEE"]
...
ctx["BESCHEINIGUNG_IN_STEUERSACHEN_FEE"] = _v["BESCHEINIGUNG_IN_STEUERSACHEN_FEE"]  # dienstleistung/324713
ctx["ERWEITERTE_MELDEBESCHEINIGUNG_FEE"] = _v[
    "ERWEITERTE_MELDEBESCHEINIGUNG_FEE"
]  # (€) - service.berlin.de/dienstleistung/120702
ctx["GEWERBEANMELDUNG_FEE"] = _v["GEWERBEANMELDUNG_FEE"]  # € - service.berlin.de/dienstleistung/121921
ctx["HUNDEREGISTER_FEE"] = _v["HUNDEREGISTER_FEE"]  # € - hunderegister.berlin.de
ctx["HUNDESTEUER_FIRST_DOG"] = _v["HUNDESTEUER_FIRST_DOG"]  # §4 HuStG BE, (€/y)
ctx["HUNDESTEUER_MORE_DOGS"] = _v["HUNDESTEUER_MORE_DOGS"]  # §4 HuStG BE, (€/y)
...
ctx["KSK_MIN_INCOME"] = _v["KSK_MIN_INCOME"]  # (€/y) - §3 Abs. 1 KSVG

# Minimum income used to calculate cost of health insurance and Pflegeversicherung
ctx["KSK_MIN_HEALTH_INSURANCE_INCOME"] = _v[
    "KSK_MIN_HEALTH_INSURANCE_INCOME"
]  # Mindestbeitragsberechnungsgrundlage (€/y)

ctx["ORDNUNGSAMT_DANGEROUS_DOG_FEE"] = _v["ORDNUNGSAMT_DANGEROUS_DOG_FEE"]  # service.berlin.de/dienstleistung/326263
ctx["RUNDFUNKBEITRAG_FEE"] = _v["RUNDFUNKBEITRAG_FEE"]
ctx["SCHUFA_REPORT_FEE"] = _v["SCHUFA_REPORT_FEE"]  # TODO: Not watched
ctx["VEHICLE_UMMELDUNG_FEE"] = _v["VEHICLE_UMMELDUNG_FEE"]  # service.berlin.de/dienstleistung/120658
ctx["LICENSE_PLATE_COST"] = _v["LICENSE_PLATE_COST"]

ctx["FIRST_AID_COURSE_COST"] = _v["FIRST_AID_COURSE_COST"]
ctx["DRIVING_LICENCE_CONVERSION_FEE"] = _v["DRIVING_LICENCE_CONVERSION_FEE"]  # (€) - /dienstleistung/327537
ctx["DRIVING_LICENCE_FEE"] = _v["DRIVING_LICENCE_FEE"]  # (€) - service.berlin.de/dienstleistung/121627
ctx["FIRST_AID_COURSE_FEE"] = _v["FIRST_AID_COURSE_FEE"]
ctx["DRIVING_SCHOOL_FEE"] = _v["DRIVING_SCHOOL_FEE"]
ctx["DRIVING_PRACTICE_FEE"] = _v["DRIVING_PRACTICE_FEE"]  # per 45-minute lesson
ctx["DRIVING_THEORY_EXAM_FEE"] = _v["DRIVING_THEORY_EXAM_FEE"]  # Dekra/TÜV fee
ctx["DRIVING_PRACTICAL_EXAM_FEE"] = _v["DRIVING_PRACTICAL_EXAM_FEE"]  # Dekra/TÜV fee

ctx["LEGAL_HOTLINE_COST_PER_MINUTE"] = _v["LEGAL_HOTLINE_COST_PER_MINUTE"]
